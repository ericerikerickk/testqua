...
<body class="guide-background">
           ...
           <p class="word2">
            ...
            <h3 class="word1">What type of artwork do you exhibit?</h3>
                <p class="word2">DASHING + ART exhibits original artworks created by new and established artists from the Philippines.</p>
            ...
            <h3 class="word1" >Where is DASHING + ART based?</h3>
